...
st.markdown("<h1 style = 'color: #0174BE; text-align: center; font-family:helvetica'>house price prediction</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #E5D4FF; text-align: center; font-family: cursive'>Built By Orpheus</h4>", unsafe_allow_html = True)
